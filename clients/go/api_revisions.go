...
func (r ApiApiRevisionsGetRequest) SearchText(searchText string) ApiApiRevisionsGetRequest {
	r.searchText = &searchText
	return r
}

// The requested API version
func (r ApiApiRevisionsGetRequest) ApiVersion(apiVersion string) ApiApiRevisionsGetRequest {
...
// The requested API version
func (r ApiApiRevisionsPostRequest) ApiVersion(apiVersion string) ApiApiRevisionsPostRequest {
	r.apiVersion = &apiVersion
	return r
}
...
func (a *RevisionsApiService) ApiRevisionsPostExecute(r ApiApiRevisionsPostRequest) (*http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.registerRevisionCommand == nil {
		return nil, reportError("registerRevisionCommand is required and must be specified")
	}
