...
// checks if the RevisionComponentDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevisionComponentDto{}
...
func (o RevisionComponentDto) ToMap() (map[string]interface{}, error) {
