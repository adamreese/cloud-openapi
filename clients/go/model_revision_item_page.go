...
// checks if the RevisionItemPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevisionItemPage{}
...
func (o RevisionItemPage) ToMap() (map[string]interface{}, error) {
