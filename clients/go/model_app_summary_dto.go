...
// checks if the AppSummaryDto type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppSummaryDto{}
...
func (o AppSummaryDto) ToMap() (map[string]interface{}, error) {
