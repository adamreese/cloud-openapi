...
// checks if the AppItemPage type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &AppItemPage{}
...
func (o AppItemPage) ToMap() (map[string]interface{}, error) {
