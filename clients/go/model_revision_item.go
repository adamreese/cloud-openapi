...
// checks if the RevisionItem type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RevisionItem{}
...
func (o RevisionItem) ToMap() (map[string]interface{}, error) {
