...
// checks if the RegisterRevisionCommand type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &RegisterRevisionCommand{}
...
func (o RegisterRevisionCommand) ToMap() (map[string]interface{}, error) {
